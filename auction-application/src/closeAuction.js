...
/**
 * @description Submits the close auction transaction to the ledger and evaluates the result.
...
async function closeAuction(ccp, wallet, user, auctionID) {
  try {
    ...
    let statefulTxt = contract.createTransaction('CloseAuction');
    ...
    console.error(`Failed to submit close auction transaction: ${error}`);
  }
}
